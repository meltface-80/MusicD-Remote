...
one tap from the **settings cog → Check for updates** in the web UI, or wait
for the update toast to appear. The container restarts itself to apply the
update.
...
wget https://raw.githubusercontent.com/meltface-80/Roon-Random-Albums-Extension/main/roon-random-albums-v{NEW_VERSION}-docker.tar.gz
...
- **Update fails with "extraction failed"**
  ...
  section above. From v1.5.10 onward this is fixed automatically.
