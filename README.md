...
# MusicD Remote (for Roon) - v1.8.59
...
wget https://github.com/meltface-80/MusicD-Remote/releases/download/v1.8.59/MusicD-Remote-v1.8.59.tar.gz
tar -xzf MusicD-Remote-v1.8.59.tar.gz
docker build -t musicd-remote:1.8.59 .
docker run -d \
  --name musicd-remote \
...
cd ~/musicd-remote
curl -L -o MusicD-Remote-v1.8.59.tar.gz \
https://github.com/meltface-80/MusicD-Remote/releases/download/v1.8.59/MusicD-Remote-v1.8.59.tar.gz
tar -xzf MusicD-Remote-v1.8.59.tar.gz
docker build -t musicd-remote:1.8.59 .
```
...
```bash
docker run -d ... -e RRA_DEBUG=1 musicd-remote:1.8.59
```
