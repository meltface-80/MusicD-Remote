 ...
 *   -ar 8000         8 kHz. A progress bar has ~1000 buckets for a whole track,
 *                    so a bucket already spans a third of a second at 8 kHz —
 *                    decoding at 44.1 and throwing 98% of it away costs five
 *                    times the CPU for a visually identical answer
 *
...
module.exports = { decodeWaveform, lastDecodeError, ffmpegPath, args, pipeArgs, DEFAULT_TIMEOUT_MS };
